...
>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('admin/vendor/fonts/boxicons.cs')}}s" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-3">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="fw-bolder fs-3" style="color: black">Ride<span style="color: #fdbe33">it</span></span>
                </a>
              </div>
              <!-- /Logo -->
              <form id="formAuthentication" class="mb-3" action="{{route('login.process')}}" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100 border border-none" type="submit">Sign in</button>
                </div>
              </form>
            </div>
          </div>
